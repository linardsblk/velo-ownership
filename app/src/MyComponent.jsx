  ...
  return (
    <div className="App">
      ...
      {/* <div className="section">
            ...
            <h3>Add new bike</h3>
            <ContractForm drizzle={drizzle} contract="BicycleOwnership" method="addBike" />
          </div>
          ...
          <div className="section">
            ...
            <p>
              Finally this contract shows data types with additional considerations. Note in the code the strings below
              are converted from bytes to UTF-8 strings and the device data struct is iterated as a list.
            </p>
            <p>
