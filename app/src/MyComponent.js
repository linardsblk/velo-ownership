    ...
    <div className="App">
      ...
      <div className="section">
        ...
        <p>
          ...
          indicator. We've suppressed it with the
          {' '}
          <code>hideIndicator</code>
          {' '}
          prop because we know this variable is
          constant.
        </p>
        <p>
      ...
      <div className="section">
        ...
        <p>
          Finally this contract shows data types with additional considerations. Note in the code the strings below are
          converted from bytes to UTF-8 strings and the device data struct is iterated as a list.
        </p>
        <p>
